...
public class AccountWebController {
    ...
    public String login(HttpServletRequest request, Model model, Authentication authentication) {
        ...
        OAUTH2 oauth = security.getOAUTH2();
        if (oauth != null) {
        ...
        model.addAttribute("loginMethod", security.getLoginMethod());
        model.addAttribute("oAuth2Enabled", security.getOAUTH2().getEnabled());
        model.addAttribute("samlEnabled", security.getSAML().getEnabled());
        model.addAttribute("saml2registrationId", security.getSAML().getRegistrationId());
